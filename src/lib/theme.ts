...
const KNIGHT_THEME: ThemeConfig = {
  ...
  pinchLabel: 'ピンチ！',
  arenaLabel: '⚔️ 練習して攻撃！',
  attackLabel: '🚀 修行の成果を送る！',
  attackVideoLabel: '🚀 動画と一緒に送る！',
  attackStreakLabel: (lbl) => `🔥 ${lbl}で送る！`,
  finisherLabel: '— 撃破！⚡',
  lowHpEmoji: '😡',
  defeatCreatureEmoji: '💀',
  creatures: MONSTERS,
...
const PRINCESS_THEME: ThemeConfig = {
  ...
  attackLabel: '💌 先生にお知らせする ✨',
  attackVideoLabel: '💌 動画と一緒にお知らせ ✨',
  attackStreakLabel: (lbl) => `✨ ${lbl}でお知らせ！`,
  finisherLabel: '— なかよし！✨',
  lowHpEmoji: '🥺',
  defeatCreatureEmoji: '✨',
